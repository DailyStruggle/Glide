...
public class TabComplete implements TabCompleter {
    ...
    private final SubCommand subCommands = new SubCommand("glide");

    public TabComplete() {
        //load glide commands and permission nodes into map
        subCommands.addSubParam("player","glide.use.other");

        subCommands.commands.put("reload",new SubCommand("glide.reload"));
        subCommands.commands.put("help",new SubCommand("glide.use"));
    }
